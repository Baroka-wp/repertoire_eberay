    ...
    return (
        <div className="min-h-screen bg-neutral-50">
            ...
            <header className="bg-white border-b border-neutral-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex items-center justify-center h-20 gap-4">
                        ...
                        />
                        <div>
                            <h1 className="text-xl font-bold text-slate-900">Inscription au Répertoire Groupe SP</h1>
                            <p className="text-sm text-slate-600">Formulaire d&apos;inscription pour répétiteurs</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-10">
                ...
                <form action={inscriptionRepetiteur} className="space-y-6">
                    ...
                    {currentStep === 3 && (
                        <div className="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
                            ...
                            <div className="p-6 md:p-8 space-y-6 md:space-y-8">
                                ...
                                {/* CLASSES */}
                                <div className="bg-neutral-50 p-4 md:p-6 rounded-lg border border-neutral-200">
